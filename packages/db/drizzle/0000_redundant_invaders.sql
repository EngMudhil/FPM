CREATE TYPE "public"."login_event_type" AS ENUM('SUCCESS', 'FAILURE', 'LOCKOUT');--> statement-breakpoint
CREATE TYPE "public"."workspace_role" AS ENUM('OWNER', 'ADMIN', 'MEMBER', 'VIEWER');--> statement-breakpoint
CREATE TABLE "login_events" (
	"id" text PRIMARY KEY NOT NULL,
	"user_id" text,
	"workspace_id" text,
	"type" "login_event_type" NOT NULL,
	"ip_address" text,
	"user_agent" text,
...
ALTER TABLE "login_events" ADD CONSTRAINT "login_events_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "login_events_type_idx" ON "login_events" USING btree ("type");--> statement-breakpoint
